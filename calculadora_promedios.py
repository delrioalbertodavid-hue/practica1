...
def main():
    UMBRAL = 5.0
    materias, calificaciones= calculadora_promedios.ingresar_calificaciones()
    promedio = calculadora_promedios.calcular_promedio(calificaciones)
    maximo, minimo = calculadora_promedios.encontrar_extremos(calificaciones)
    aprobadas, reprobadas= calculadora_promedios.determinar_estado(calificaciones,UMBRAL)
